                    ...
                    <div class="product-card">
                        <a href="product-details.html">
                            ...
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">{{ $recentProduct->name }}</h2>
                                    <h3 class="product-price">${{ $recentProduct->selling_price }}</h3>
                                </div>
                                <div>
                                    <form action="{{ route('cart.add',['id'=>$recentProduct->id]) }}" method="POST">
                                        @csrf
                       ...
                       <form action="{{ route('wishlist.add') }}" method="POST" style="display: inline;">
                        ...
                        <button href="wishlist.html" class="heart-icon">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
