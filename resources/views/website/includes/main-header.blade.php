...
<header class="font-display">
                ...
                <div class="flex justify-between items-center py-5">
                    ...
                    <div class="lg:block hidden">
                        <ul class="flex items-center gap-3">
                            <li class="relative">
                                <a href="#" class="inline-flex gap-2 hover:text-[#007580] bg-white rounded-lg p-[11px]" id="addToCart">
                                    <span><svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke-linejoin="round" />
                                            <path d="M12.948 9.89542H15.4899" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <li class="relative">
                                <a href="{{ route('wishlist.index') }}" class="inline-flex bg-white text-gray-black hover:text-[#007580] rounded-lg p-[11px]">  <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <div class="nav-menu" id="nav-menu">
        <div class="flex justify-between  items-center px-3 py-4 mb-4">
            <div>
                <a href="#">
                    <img src="{{ asset('/') }}website/assets/images/all-img/logo-sm.png" alt="">
                </a>
            </div>
            <ul class="flex items-center gap-3">
                <li>
