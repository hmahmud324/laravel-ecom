                ...
                @foreach ($featured_products as $featured_product)
                 <div class="swiper-slide">
                     <div class="product-card">
                         <a href="{{ route('product-detail',['id'=>$featured_product->id]) }}">
                             <div class="product-thumb ">
                                 <img  style="height: 312px; width:312px;" src="{{asset($featured_product->image) }}"
                                     alt="" >
                                 <span class="badge new">New</span>
                             </div>
                             <div class="product-info">
                                 <div>
                                     <h2 class="product-name">{{ $featured_product->name }}</h2>
                                     <h3 class="product-price">${{ $featured_product->selling_price }}</h3>
                                 </div>
                                 <div>
                                    <form action="{{ route('cart.add',['id'=>$featured_product->id]) }}" method="POST">
                                        @csrf
