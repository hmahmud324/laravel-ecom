    ...
    <div class="container mt-3">
        <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal" action="{{route('testimonial.new')}}" method="POST" enctype="multipart/form-data">
                @csrf
                 <div class=" row mb-4">
                    <label for="inputEmail3" class="col-md-3 form-label">Text</label>
                    <div class="col-md-9">
                        <textarea  class="form-control" name="text" id="inputEmail3" placeholder="Testimonial Description"></textarea>
                    </div>
                </div>
                <div class=" row mb-4">
                    <label for="inputName" class="col-md-3 form-label">Author Name</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="inputName" name="author_name" placeholder="Testimonial Name"/>
                 ...
                 <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="inputName" name="author_role" placeholder="Testimonial Name"/>
                ...
                <div class="mb-0 mt-4 row justify-content-end">
                    <div class="col-md-9">
                        <button class="btn  btn-primary">Create New Testimonial</button>
                    </div>
                </div>
            </form>
            </div>
