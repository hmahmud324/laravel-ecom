    ...
    <div class="col-md-12">
       <div class="container">
        <div class="page-header">
            <div>
                <h1 class="page-title">Edit Brand Info</h1>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('brand.update',['id'=>$brand->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class=" row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="inputName" value="{{$brand->name}}" name="name" placeholder="Brand Name"/>
                                <span class="text-danger">{{$errors->has('name') ? $errors->first('name') : ' '}}</span>
                            </div>
                        </div>
                        <div class="mb-0 mt-4 row justify-content-end">
                            <div class="col-md-9 me-auto">
                                <button class="btn btn-primary">Update Brand Info</button>
                            </div>
                        </div>
                    </form>
                </div>
