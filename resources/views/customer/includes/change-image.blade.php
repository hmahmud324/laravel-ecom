        ...
        <div class="p-6">
            ...
            <form action="{{ route('update-profile-Image') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                ...
                <div class="pb-[26px] mx-auto">
                    <img  id="image-preview" class="w-[150px] h-[150px] rounded-full mx-auto object-cover" src="{{ asset($customer->image) }}" alt="image description" id="blah">
                </div>
